...
const (
	...
	PaymentOutcomeAggregateComplete   = "aggregate_complete"
	PaymentOutcomePartialAggregating  = "partial_aggregating"
	...
	PaymentOutcomeMissingMemo         = "missing_memo"
	PaymentOutcomeWrongMemo           = "wrong_memo"
	PaymentOutcomeAdminTestFailed     = "admin_test_failed"
)

const PaymentOutcomeReasonReorged = "matched transaction was reorged"

const (
	PaymentSettlementPolicySingle    = "single"
	PaymentSettlementPolicyAggregate = "aggregate"
)
...
type PaymentSession struct {
	...
	ProductSnapshot JSONData `gorm:"column:product_snapshot;type:jsonb" json:"product,omitempty"`
	...
	RequiredMemo           string             `gorm:"size:180;index" json:"required_memo,omitempty"`
	RequiredMemoNormalized string             `gorm:"size:180;index" json:"required_memo_normalized,omitempty"`
	SettlementPolicy       string             `gorm:"size:32;not null;default:'single';index" json:"settlement_policy,omitempty"`
