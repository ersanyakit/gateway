...
func (r *ReconciliationRepo) ListPage(ctx context.Context, page, limit int, status string) ([]models.ReconciliationJob, int64, error) {
	if r == nil || r.db == nil {
	...
	query := r.db.WithContext(ctx).Model(&models.ReconciliationJob{})
	...
	var rows []models.ReconciliationJob
