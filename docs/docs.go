    ...
    "paths": {
        ...
        "/api/v1/payment/link/create": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Payment or donation link parameters",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.V1PaymentLinkCreateRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/types.V1PaymentLinkCreateResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/checkout/{token}/cancel": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Rendered canceled result page",
                        "schema": {
                            "type": "string"
                        }
                    },
                    "303": {
                        "description": "Redirect to merchant cancel URL",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/docs/money-event-catalog.md": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Markdown money event catalog",
                        "schema": {
                            "type": "string"
                        }
                    },
                    "404": {
                        "description": "money event catalog not found",
                        "schema": {
                            "type": "string"
                        }
                    }
    ...
    "definitions": {
        ...
        "types.V1PaymentDetail": {
            ...
            "properties": {
                ...
                "product": {
                    "$ref": "#/definitions/types.V1PaymentProductSnapshot"
                },
                "selected_asset": {
                    "type": "string",
                    "example": "USDT"
        ...
        "types.V1PaymentLinkCreateRequest": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "string",
        ...
        "types.V1PaymentLinkCreateResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/types.V1PaymentLinkDetail"
                },
                "result": {
                    "type": "string",
                    "example": "ok"
        ...
        "types.V1PaymentLinkDetail": {
            ...
            "properties": {
                ...
                "default_asset": {
                    "$ref": "#/definitions/types.V1PaymentAssetSelection"
                },
                "default_chain_id": {
                    "type": "integer",
                    "example": 728126428
                ...
                "link_token": {
                    "type": "string",
                    "example": "b7d9f4b1c6a8e0d2f3a5b6c7d8e9f0a1b2c3"
                },
                "link_type": {
                    "type": "string",
                    "example": "donation"
                ...
                "payment_url": {
                    "type": "string",
                    "example": "https://pay.example.com/payment-links/b7d9f4b1c6a8e0d2f3a5b6c7d8e9f0a1b2c3"
                },
                "success_url": {
                    "type": "string",
                    "example": "https://example.com/success"
        ...
        "types.V1PaymentProductSnapshot": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "string",
        ...
        "types.V1PaymentStatusTableData": {
            "type": "object",
            "properties": {
                "statuses": {
                    "type": "array",
        ...
        "types.V1PaymentStatusTableResponse": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/types.V1PaymentStatusTableData"
                },
                "result": {
                    "type": "string",
                    "example": "ok"
