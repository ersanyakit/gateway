...
func TestHandleERC20LogSkipsZeroAmountTransfer(t *testing.T) {
	...
	events := bus.Subscribe(constants.Ethereum, 1)
...
func (t testWSChain) ChainID() constants.ChainID { return constants.Ethereum }
func (t testWSChain) Name() string               { return "ethereum" }
