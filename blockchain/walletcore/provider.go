...
type Provider interface {
	...
	ValidateAddress(address string, chainID constants.ChainID) bool
	AddressFromPrivateKey(privateKeyHex string, chainID constants.ChainID) (string, error)
...
func ValidateAddress(address string, chainID constants.ChainID) bool {
	return provider.ValidateAddress(strings.TrimSpace(address), chainID)
}

func AddressFromPrivateKey(privateKeyHex string, chainID constants.ChainID) (string, error) {
	return provider.AddressFromPrivateKey(strings.TrimSpace(privateKeyHex), chainID)
}
